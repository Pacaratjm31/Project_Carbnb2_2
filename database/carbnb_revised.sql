-- ============================================================
-- CARBNB DATABASE - COMPLETE SETUP
-- ============================================================
...
CREATE TABLE IF NOT EXISTS user_documents (
    ...
    document_type ENUM('id1', 'id2', 'proof_of_billing', 'drivers_license', 'nbi_clearance', 'intro_video') NOT NULL,
...
CREATE TABLE IF NOT EXISTS bookings (
    ...
    CONSTRAINT fk_bookings_admin FOREIGN KEY (admin_id) REFERENCES users(id) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS reviews (
    ...
    reply TEXT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_reviews_renter FOREIGN KEY (renter_id) REFERENCES users(id),
...
CREATE TABLE IF NOT EXISTS inspect (
    ...
    CONSTRAINT fk_inspect_booking FOREIGN KEY (booking_id) REFERENCES bookings(id) ON DELETE CASCADE,
    CONSTRAINT fk_inspect_renter FOREIGN KEY (renter_id) REFERENCES users(id) ON DELETE CASCADE,
    CONSTRAINT fk_inspect_owner FOREIGN KEY (owner_id) REFERENCES users(id) ON DELETE CASCADE,
    CONSTRAINT fk_inspect_vehicle FOREIGN KEY (vehicle_id) REFERENCES vehicles(id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
